...
import (
	"fmt"
	"github.com/arisgk/goa-api-data-table/client"
	"github.com/arisgk/goa-api-data-table/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "Data Table-cli",
		Short: `CLI client for the Data Table service`,
	}
